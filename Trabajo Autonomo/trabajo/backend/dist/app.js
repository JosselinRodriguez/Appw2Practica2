...
const servicio_route_1 = __importDefault(require("./src/routes/servicio.route"));
const tipo_servicio_route_1 = __importDefault(require("./src/routes/tipo_servicio.route"));
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // Register API routes
        app.use("/api/v1/", servicio_route_1.default);
        app.use("/api/v1/", reserva_route_1.default);
        app.use("/api/v1/", tipo_servicio_route_1.default);
